 ...
 * values with count 1.
 * <p>
 * In case the Stratifier does not consist of components but of criteria, a set will hold only one {@link ComponentKeyPair}.
 * <p>
 ...
 */
public record StratifierResult(HashableCoding code, Map<Set<ComponentKeyPair>, PopulationsCount> counts) {

    public void mergeResourceResult(Set<ComponentKeyPair> r) {
        counts.merge(r, PopulationsCount.INITIAL_ONE, PopulationsCount::merge);
    }
