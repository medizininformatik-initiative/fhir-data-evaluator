...
class DataStoreTest {
    ...
    class TestGet {
        ...
        void initialize() {
            ...
            dataStore = new DataStore(client, null, parser, 1000, context, context.newFhirPath());
        }
    ...
    class TestPost {
        ...
        void initialize() {
            ...
            FhirContext context = FhirContext.forR4();
            IParser parser = context.newJsonParser();
            dataStore = new DataStore(null,client, parser, 1000, context, context.newFhirPath());
        }
